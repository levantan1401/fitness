...
import 'package:fitness/screens/common_widgets/fitness_text_field.dart';
import 'package:fitness/screens/sign_up/bloc/signup_bloc.dart';
...
class SignUpContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        width:
            double.infinity, // tạo một container với chiều rộng không giới hạn
        height:
            double.infinity, // tạo một container với chiều cao không giới hạn
